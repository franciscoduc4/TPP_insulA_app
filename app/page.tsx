...
import { Loader2, ArrowUp, ArrowDown, Check, Utensils, Syringe, Droplet, Plus } from 'lucide-react'
    ...
    <div className="container mx-auto p-4 space-y-6">
      ...
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogTrigger asChild>
          <Button className="fixed bottom-20 right-4 bg-[#22c55e] hover:bg-[#22c55e]/90 text-white rounded-full p-4 shadow-lg">
